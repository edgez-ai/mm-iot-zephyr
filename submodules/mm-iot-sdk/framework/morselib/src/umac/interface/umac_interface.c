...
static enum mmdrv_interface_type umac_interface_to_drv_if_type(enum umac_interface_type type)
{
                                                   ...
                                                   enum umac_interface_type type)
{
    ...
    if ((data->active_interface_types & VIF_STA_INTERFACE_TYPES_MASK) &&
        (type & (UMAC_INTERFACE_AP | UMAC_INTERFACE_MESH)))
    {
        return false;
    }


    if ((data->active_interface_types & (UMAC_INTERFACE_AP | UMAC_INTERFACE_MESH)) &&
        (type & VIF_STA_INTERFACE_TYPES_MASK))
    {
        return false;
    }

    if ((data->active_interface_types & UMAC_INTERFACE_AP) && (type & UMAC_INTERFACE_MESH))
    {
        return false;
    }

    if ((data->active_interface_types & UMAC_INTERFACE_MESH) && (type & UMAC_INTERFACE_AP))
    {
        return false;
    }
                                      ...
                                      uint16_t *vif_id)
{
    ...
    if (data->active_interface_types == 0)
    {
        ...
        enum mmdrv_interface_type drv_if_type = umac_interface_to_drv_if_type(type);
    ...
    else if (!(data->active_interface_types & UMAC_INTERFACE_MESH) && (type == UMAC_INTERFACE_MESH))
    {
        MMOSAL_DEV_ASSERT(!(data->active_interface_types & UMAC_INTERFACE_AP));
        ret = mmdrv_rm_if(data->vif_id);
        MMOSAL_ASSERT(ret == 0);
        data->vif_id = 0;
